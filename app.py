...
# Configuração das páginas do Streamlit
st.set_page_config(page_title="Ciclo Menstrual App", layout="wide")

# Sidebar para navegação
page = st.sidebar.radio("Navegação", ['Perfil', 'Ciclo Menstrual', 'Histórico'])
